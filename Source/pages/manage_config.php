...
$f_enable_force_fixed_in_version= gpc_get_bool( 'enable_force_fixed_in_version', OFF );
...
maybe_set_option( 'enable_force_fixed_in_version', $f_enable_force_fixed_in_version );
